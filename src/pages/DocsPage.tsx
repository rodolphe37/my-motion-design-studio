...
const CONTENT: Record<string, { title: string; body: { h?: string; p: string }[] }> = {
  ...
  interface: {
    ...
    body: [
      ...
      { h: 'Panneaux de droite', p: "Cinq onglets : Propriétés (édite l'élément sélectionné), Calques (liste des éléments de la scène courante), Anim (keyframes de l'élément sélectionné), Trans. (transition vers la scène suivante), Scène (durée de la scène courante, et fond de scène en mode 2D)." },
  ...
  tools2d: {
    ...
    body: [
      ...
      { h: 'Fond de scène', p: "Chaque scène peut définir son propre fond dans l'onglet « Scène » du panneau de droite : uni, en dégradé (deux couleurs + angle), ou avec des spots de couleur sur un fond uni (ajout/suppression de spots, position, rayon, opacité réglables). Sans réglage spécifique, la scène utilise la couleur de fond définie dans les paramètres du projet. Ce réglage n'est disponible qu'en mode 2D." },
    ],
  },
  objects3d: {
  ...
  camera3d: {
    ...
    body: [
      ...
      { h: 'Environnement', p: "Color (fond uni, sans réflexions), Gradient (reflets d'un environnement urbain sur les matériaux) ou HDRI Studio (reflets d'un studio photo) — modifiable à tout moment via les Réglages du projet. Affecte l'aspect des matériaux réfléchissants, pas la couleur de fond visible (définie séparément, également dans les Réglages du projet)." },
